...
public class SimpleMonthView extends View {
	...
	protected void drawMonthNums(Canvas canvas) {
        ...
        /*
        if((mMonth <= mMinDate.month && mYear <= mMinDate.year) || (mMonth >= mMaxDate.month && mYear >= mMaxDate.year)){
...
/*
                    if(!mMaxDate.isAfter(new SimpleMonthAdapter.CalendarDay(mYear,mMonth,day)) && !mMaxDate.equals(new SimpleMonthAdapter.CalendarDay(mYear,mMonth,day))){
                        mMonthNumPaint.setColor(mDayDisabledTextColor);
                    }
*/
