...
public class DatePickerDialog extends DialogFragment implements View.OnClickListener, DatePickerController {
    ...
    public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int year, int month, int day, SimpleMonthAdapter.CalendarDay maxDate) {
        return newInstance(onDateSetListener, year, month, day, false, maxDate);
    }

    public static DatePickerDialog newInstance(OnDateSetListener onDateSetListener, int year, int month, int day, boolean vibrate, SimpleMonthAdapter.CalendarDay maxDate) {
    ...
    private void setCurrentView(int currentView, boolean forceRefresh) {
      ...
      //  String m = ""+(maxDate.month+1);
        //if(m.length()==1) m="0"+m;

        //mUntilDate.setText(maxDate.year + "." + m + "." + maxDate.day + "-ig lehet időpontot megadni");
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup parent, Bundle bundle) {
        ...
        mUntilDate = ((TextView) view.findViewById(R.id.untildate));
