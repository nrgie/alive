...
package com.blueobject.app.alive.picker;
...
public class FriendPickerFragment extends PickerFragment {
    ...
    public EditText updateable;

    public void setUpdateField(EditText field) {
    ...
    public void setSettingsFromBundle(Bundle inState) {
        ...
        if (inState != null) {
            ...
            setMultiSelect(false) ; //inState.getBoolean(MULTI_SELECT_BUNDLE_KEY, multiSelect));
            if (inState.containsKey(FRIEND_PICKER_TYPE_KEY)) {
                try {
                    friendPickerType = FriendPickerType.TAGGABLE_FRIENDS; //valueOf(inState.getString(FRIEND_PICKER_TYPE_KEY));
                } catch (Exception e) {
                    // NOOP
                }
            }
    ...
    GraphRequest getRequestForLoadData() {
        ...
        String userToFetch = "me"; //(userId != null) ? userId : "me";
