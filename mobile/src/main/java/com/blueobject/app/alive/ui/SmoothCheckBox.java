...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED = Color.parseColor("#CF2020");
    private static final int COLOR_CHECKED_DISBLED = Color.parseColor("#C9ADAD");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#DFDFDF");
    private static final int COLOR_FLOOR_UNCHECKED_DISABLED = Color.parseColor("#EFEFEF");
    ...
    private void reset() {
        ...
        if(disabled)
            mFloorColor = isChecked() ? COLOR_CHECKED_DISBLED : COLOR_FLOOR_UNCHECKED_DISABLED;
        else
    ...
    private void startCheckedAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if(disabled)
                    mFloorColor = getGradientColor(mUnCheckedColor, COLOR_CHECKED_DISBLED, 1 - mScaleVal);
                else
    ...
    private void startUnCheckedAnimation() {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if(disabled)
                    mFloorColor = getGradientColor(COLOR_CHECKED_DISBLED, mFloorUnCheckedColor, mScaleVal);
                else
