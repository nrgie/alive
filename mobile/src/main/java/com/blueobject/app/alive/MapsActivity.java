...
public class MapsActivity extends LocalizationActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
        for(final ProtectedModel p : Global.user.protecteds) {
            TextView v = (TextView) LayoutInflater.from(this).inflate(R.layout.protected_list_row, null);
            v.setText(p.name);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.e("SELECTED", p.email);
                    enableMyLocation();
                }
            });
            list.addView(v);
