...
public class AllergyListViewAdapter extends RecyclerView.Adapter<AllergyListViewAdapter.CustomViewHolder> {
    ...
    public AllergyListViewAdapter(Context context, ArrayList<MedicalModel> list) {
        this.data = list;
