...
public class Input_Dialog extends DialogFragment implements View.OnClickListener, ListView.OnItemClickListener{
    ...
    public static Input_Dialog newInstance(String title, ArrayList<String> dialogItems, String negativeButton, String positiveButton, MyDialogListener dialogListener) {
        Input_Dialog f = new Input_Dialog();
