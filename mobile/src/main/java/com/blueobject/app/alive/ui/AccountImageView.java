 ...
 */
public class AccountImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public AccountImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AccountImageView, defStyle, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!mCacheValid || width != mCachedWidth || height != mCachedHeight) {
            ...
            if (width == mCachedWidth && height == mCachedHeight) {
                ...
                mCachedWidth = (int) (width);
                mCachedHeight = (int) (height);
            }
