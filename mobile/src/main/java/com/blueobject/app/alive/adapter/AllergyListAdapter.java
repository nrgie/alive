...
public class AllergyListAdapter extends RecyclerView.Adapter<AllergyListAdapter.CustomViewHolder> {
    ...
    public AllergyListAdapter(Context context, ArrayList<AllergyModel> list) {
        this.data = list;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.allergy_list_item, null);
            ...
            public void onClick(DialogInterface dialog, int choice) {
                switch (choice) {
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        ArrayList<AllergyModel> glist = (ArrayList<AllergyModel>) Global.user.customallergies.clone();
                        for(AllergyModel g : glist) {
                            if(g.name.equals(name)) {
                                Global.user.customallergies.remove(g);
                            }
                        }

                        Global.saveUser();
                        //data.clear();
                        //data.addAll(Global.user.customallergies);
