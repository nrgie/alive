...
public class MedListViewAdapter extends RecyclerView.Adapter<MedListViewAdapter.CustomViewHolder> {
    ...
    public MedListViewAdapter(Context context, ArrayList<MedModel> list) {
        this.data = list;
    ...
    public void onBindViewHolder(final CustomViewHolder v, int i) {
        ...
        final MedModel item = data.get(i);
