...
public class TerrorMapActivity extends LocalizationActivity implements
    ...
    private static final String TAG = TerrorMapActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_terror);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CommonUtilities.dumpIntent(getIntent());

        final PModel pm = new PModel();
        pm.latlng = new LatLng(Double.parseDouble(lat), Double.parseDouble(lng));
        pm.marker = mMap.addMarker(new MarkerOptions().position(pm.latlng).title(getResources().getString(R.string.terrorTitle)));
        markers.add(pm);
...
/*
    ...
    public void setnotfound(){
        ...
        //found.setText(getResources().getString(R.string.notfoundprot));
    }
    ...
    public class GetPos extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... data) {
            ...
            if(Global.user.protecteds.size() == 0) {
                return "";
            }
            HttpClient httpclient = new DefaultHttpClient();
            HttpPost httppost = new HttpPost("http://api.saveme-app.com/getpos.php");
            try {
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(1);
                nameValuePairs.add(new BasicNameValuePair("myemail", Global.user.email));
                nameValuePairs.add(new BasicNameValuePair("prot", Global.gson.toJson(Global.user.protecteds)));
            ...
            try {
                ...
                for(ProtectedModel p : ps) {
                    ...
                    if(p.lat != null && p.lng != null && !p.lat.equals("") && !p.lng.equals("")) {
                        ...
                        TextView v = (TextView) inflater.inflate(R.layout.protected_list_row, null);
                        v.setText(p.name);
